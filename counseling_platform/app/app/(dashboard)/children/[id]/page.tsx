...
async function getChildData(childId: string, userRole: string, userId: string) {
...
export default async function ChildDetailPage({ params }: PageProps) {
  ...
  try {
    const child = await getChildData(params.id, userRole, userId);
      ...
      <div className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {lastSession 
                      ? formatDistanceToNow(new Date(lastSession.createdAt)) + " ago"
                      : "No sessions yet"
                    }
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900">
                    {lastSession?.summary?.resolutionStatus || "Assessment needed"}
                  </p>
                </div>
        ...
        <Tabs defaultValue="briefing" className="space-y-6">
          ...
          <TabsContent value="profile">
            <ProfileDetails child={child} userRole={userRole} />
          </TabsContent>
        </Tabs>
      </div>
    );
